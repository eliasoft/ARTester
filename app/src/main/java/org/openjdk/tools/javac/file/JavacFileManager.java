...
public class JavacFileManager extends BaseFileManager implements StandardJavaFileManager {
    ...
    public <S> ServiceLoader<S> getServiceLoader(Location var1, Class<S> var2) throws IOException {
        nullCheck(var1);
        nullCheck(var2);
        try{Object o=getClass().getMethod("getModule").invoke(getClass());o.getClass().getMethod("addUses",Class.class).invoke(o, var2);}catch(ReflectiveOperationException roe){}
